...
import ai.shape.basics.routerservlet.ExceptionListener;
import ai.shape.basics.routerservlet.ServerRequest;
import ai.shape.basics.routerservlet.ServerResponse;
...
public class ServerExceptionListener implements ExceptionListener {
  ...
  public void exception(ServerRequest request, ServerResponse response, Throwable exception) {
    latestServerException = exception;
  }
}
